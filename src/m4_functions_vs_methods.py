...
def try_methods():
    ...
    ###########################################################################
    konner = rg.SimpleTurtle()
    konner.pen = rg.Pen('brown', 5)
    konner.speed = 7
...
def try_methods_and_functions():
    ...
    ###########################################################################
    johnathan = rg.SimpleTurtle()
    johnathan.pen = rg.Pen('blue', 5)

    johnathan.backward(150)
    johnathan.speed = 1
    draw_many_squares(johnathan, 2, 100, 30)

    johnathan.speed = 5
    johnathan.pen = rg.Pen('red', 5)
    draw_many_squares(johnathan, 10, 50, 15)

    johnathan.speed = 100
    johnathan.pen = rg.Pen('red', 35)
    draw_many_squares(johnathan, 8, 300, 60)

    johnathan.pen = rg.Pen('black', 3)
    johnathan.backward(200)
    johnathan.draw_circle(30)
    johnathan.draw_square(50)
