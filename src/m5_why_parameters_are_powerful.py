...
def main():
    ...
    # better_draw_circles(rg.Point(34, 4), 5)
    # better_draw_circles(rg.Point(47, 48), 38)

    # even_better_draw_circles(rg.Point(100, 50), 24, 'red', 1, 10)
    # even_better_draw_circles(rg.Point(-200, 0), 24, 'blue', 8, 10)

    even_better_draw_circles(rg.Point(123, 345), 4, 'pink', 4, 57)
    even_better_draw_circles(rg.Point(234, 7), 356, 'purple', 345, 5)
    even_better_draw_circles(rg.Point(45, 45), 345, 'orange', 4, 45)
    even_better_draw_circles(rg.Point(789, 6), 348, 'red', 348, 94)
...
def better_draw_circles(point, val):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(val * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, radii, color, thick, circles):
